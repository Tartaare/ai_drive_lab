...
Dans notre app on détecte automatiquement sur les modeles 3D les parties du véhicule dont on a besoin (roues, etc.).
...
; puis améliore notre système de détection.
