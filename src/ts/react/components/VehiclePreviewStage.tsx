...
export function VehiclePreviewStage({ vehicle, adjacentVehicles, direction, theme, highlightedNodeIds, garageMode, pickingMode, onNodePicked, previewRef, onTransitionChange }: VehiclePreviewStageProps): JSX.Element {
